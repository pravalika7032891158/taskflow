...
import {WRAPPER, HEADER, ADD_BUTTON, STATS_GRID, STATS, STAT_CARD, ICON_WRAPPER,FILTER_WRAPPER, VALUE_CLASS, LABEL_CLASS, FILTER_LABELS, FILTER_OPTIONS, TABS_WRAPPER, EMPTY_STATE,SELECT_CLASSES,TAB_BASE,TAB_ACTIVE,TAB_INACTIVE} from '../assets/dummy'
...
const API_BASE='https://taskmanager-app-backend-flyo.onrender.com/api/tasks'
...
const Dashboard = () => {
  ...
  const handleTaskSave=useCallback(async(task)=>{
    try{
      if (task.id){
         await axios.put(`${API_BASE}/${task.id}/gp`,task);
      } 
      else {
      await axios.post(`${API_BASE}/gp`,task);
    }
      refreshTasks()
      setShowModal(false)
    ...
    <div className={WRAPPER}>
      ...
      <div className={HEADER}>
        <div className='min-w-0'>
          ...
          <p className='text-sm text-gray-500 mt-1 ml-7 truncate'>Manage your tasks effieciently</p>
