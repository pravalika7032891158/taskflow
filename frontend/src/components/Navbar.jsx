            ...
            <div className='flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto'>
                ...
                <div className='flex items-center gap-4'>
                    ...
                    <div ref={menuref} className='relative'>
                        ...
                        py-2 rounded-full cursor-pointer hover:bg-purple-50 transition-colors duration-300 border
                        ...
                        {menuOpen && (
                            ...
                            shadow-xl border border-purple-100 z-50 overflow-hidden animate-fadeIn'>
                                ...
                                <li className='p-2'>
                                    ...
                                    items-center gap-2 rounded-lg px-3 py-2 text-sm hover:bg-red-50 text-red-600' role='menuitem'>
