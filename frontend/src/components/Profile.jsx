...
import { BACK_BUTTON, DANGER_BTN, FULL_BUTTON, INPUT_WRAPPER, SECTION_WRAPPER , personalFields, securityFields} from '../assets/dummy'
import { useNavigate } from "react-router-dom";
import axios from 'axios';

const API_URL="https://taskmanager-app-backend-flyo.onrender.com"
      ...
      <div className='max-w-4xl mx-auto p-6'>
        ...
        <div className='flex items-center gap-4 mb-8'>
            ...
            <div>
                ...
                <p className='text-gray-500 text-sm'>Maanage your profile and security settings</p>
            </div>
